...
public class ClientRestItems {
	...
	public static void main(String[] args) {  
		...
		String rest = target.request("application/json").get(String.class);
		System.out.println("Lista de items: " + rest);
		...
		String resultado = target.request("application/json").get(itemId.getClass());
	}
}
